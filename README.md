...
```hcl
module "mssql" {
  source                  = "https://github.com/sohanyadav/terraform-google-mssql.git"
  name                    = "dev"
  user_name               = "mssql"
  db_name                 = "testdb"
  environment             = "test"
...
# Examples
For detailed examples on how to use this module, please refer to the [example](https://github.com/sohanyadav/terraform-google-mssql/tree/master/_example) directory within this repository.
...
## License
This project is licensed under the MIT License - see the [LICENSE](https://github.com/sohanyadav/terraform-google-mssql/blob/master/LICENSE) file for details.
...
| <a name="input_repository"></a> [repository](#input\_repository) | Terraform current module repo | `string` | `"https://github.com/sohanyadav/terraform-google-mssql"` | no |
